...
const app = {
  ...
  handleOnClickChange() {
    ...
    const btnChanges = parentForm.querySelectorAll(
      ".main__wrapper-from-group-btn-change"
    );

    btnChanges.forEach((btnChange) => {
      const authForm = btnChange.parentElement.querySelector(
        ".main__wrapper-from-group-change-box"
      );
